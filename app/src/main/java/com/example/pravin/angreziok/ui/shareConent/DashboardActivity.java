package com.example.pravin.angreziok.ui.shareConent;
...
import com.example.pravin.angreziok.ShowFilesOnDevice;
    ...
    public void connect(View view) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                String SSID = getWifiName(DashboardActivity.this);
                        ...
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void aVoid) {
                                ...
                                if (client1.isConnected()) {
                                    ...
                                    AOPApplication.ftpClient = client1;
